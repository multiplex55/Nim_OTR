...
- The crop dialog does not auto-open by default when you toggle **Mouse Crop**. Enable **Auto-open Crop Dialog** from the right-click menu if you want the crop window to appear automatically whenever mouse cropping is turned on.
